...
void loop() {
  if(pot1 == true){ //Cuando se activa la bandera del Potenciometro 1
    ...
    lcd.setCursor(0, 0); //Mostrar en LCD movimiento del Servo 
  ...
  if(pot2 == true){ //Cuando se activa la bandera del Potenciometro 2
    ...
    lcd.setCursor(0, 0); //Mostrar en LCD movimiento del Servo 2
    lcd.print(" Moviendo Servo ");
    lcd.setCursor(0, 1);
    lcd.print("   de Brazo 1   ");
    lcd.display();
  ...
  if(pot3 == true){ //Cuando se activa la bandera del Potenciometro 2
    ...
    lcd.setCursor(0, 0); //Mostrar en LCD movimiento del Servo 3
    lcd.print(" Moviendo Servo ");
    lcd.setCursor(0, 1);
    lcd.print("   de Brazo 2   ");
    lcd.display();
